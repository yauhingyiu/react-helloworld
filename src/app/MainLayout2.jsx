        ...
        <Col md={'auto'}>
          ...
          <Navbar expand="lg" className="flex-column vertical-navbar navbar1" data-bs-theme="dark" bg="dark">
            ...
            <Container fluid className="flex-column align-items-start">
              <Navbar.Brand href="/home2/">DCSMS</Navbar.Brand>
              <Navbar.Toggle aria-controls="basic-navbar-nav" />
              <Navbar.Collapse id="basic-navbar-nav" className="flex-column align-items-start">
                <Nav className="flex-column">
                  <Nav.Link href="/home2/form1">Form 1</Nav.Link>
                  <Nav.Link href="/home2/form2">Form 2</Nav.Link>
                  <Nav.Link href="/home2/allformstable">Safety Checklists (Table)</Nav.Link>
                  <Nav.Link href="/home2/simerror">Sim Error</Nav.Link>
                  <Nav.Link href="/settings">Settings</Nav.Link>
                  <Nav.Link href="/home2/submissions">Submissions</Nav.Link>
                  <Nav.Link href="/home2/reports">Reports</Nav.Link>
                </Nav>
              </Navbar.Collapse>
            </Container>
          </Navbar>
